    ...
    <div className=' flex justify-center items-center flex-col mt-40 '>
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 justify-center gap-8 mt-16">
        <div className="flex gap-2 bg-white  ">
            <div className="bg-black h-[44px] text-sky-400
            w-[66px] text-2xl px-4 rounded-full flex items-center justify-center">
            <FaFingerprint/>
            </div>
            <div>
                <p className="font-semibold text-base md:text-xl">AI–powered editor</p>
                <p className="text-sm text-gray-600">Assign tasks, set priorities,<br/> and track progress <br/> effortlessly</p>
            </div>
        </div>
        ...
        <div className="flex gap-2 bg-white  ">
            ...
            <div>
                ...
                Visualize trends <br/> and monitor key performances </p>
            </div>
        </div>
        ...
        <div className="flex gap-2 bg-white  ">
          ...
          text-sky-400
            ...
            <div>
                ...
                <p className="text-sm text-gray-600">
                Customize workflows, add <br/> integrations, and adapt<br/> features</p>
            </div>
        </div>
        ...
        <div className="flex gap-2 bg-white  ">
            ...
            <div>
                <p className="font-semibold text-base ">Intuitive Task <br/> Management</p>
                <p className="text-sm text-gray-600">
                Assign tasks, set priorities,<br/> and track progress<br/> effortlessly</p>
            </div>
        </div>
        ...
        <div className="flex gap-2 bg-white ">
            ...
            <div>
                <p className="font-semibold text-base ">Advanced Data<br/> Analytics</p>
                <p className="text-sm text-gray-600">
                Visualize trends and monitor<br/> key performances</p>
            </div>
        </div>
        ...
        <div className="flex gap-2 bg-white">
            ...
            <div>
                <p className="font-semibold text-base ">Scalability and <br/> Customization</p>
                <p className="text-sm text-gray-600">
                Customize workflows, add <br/>integrations, and adapt<br/> features</p>
            </div>
        </div>
